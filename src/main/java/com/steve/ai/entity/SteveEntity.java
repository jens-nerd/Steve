...
public class SteveEntity extends PathfinderMob {
    ...
    protected void addAdditionalSaveData(ValueOutput output) {
        ...
        output.store("Memory", CompoundTag.CODEC, memoryTag);
    }

    @Override
    protected void readAdditionalSaveData(ValueInput input) {
        super.readAdditionalSaveData(input);
        input.getString("SteveName").ifPresent(this::setSteveName);

        input.read("Memory", CompoundTag.CODEC).ifPresent(this.memory::loadFromNBT);
    }
